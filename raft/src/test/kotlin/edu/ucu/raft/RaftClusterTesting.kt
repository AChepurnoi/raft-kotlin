...
class RaftClusterTesting {
    ...
    private fun clusterOfThree(): List<LocalRaftNode> {
        val nodeOne = LocalRaftNode(RaftController(StaticConfiguration(1, timerInterval = 500, heartbeatInterval = 50)))
        val nodeTwo = LocalRaftNode(RaftController(StaticConfiguration(2, timerInterval = 550, heartbeatInterval = 50)))
        val nodeThree = LocalRaftNode(RaftController(StaticConfiguration(3, timerInterval = 650, heartbeatInterval = 50)))
